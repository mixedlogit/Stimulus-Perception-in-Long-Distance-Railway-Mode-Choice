...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  R[['car']]  =  asc_car - 
            ...
            log(1 + exp(b_co*(FA_BUS - CO_CAR)))*BUS_AV -
            log(1 + exp(b_co*(FA_HSR - CO_CAR)))*HSR_AV -
            log(1 + exp(b_co*(FA_AIR - CO_CAR)))*AIR_AV + b_age2_car*AGE_2 + b_age3_car*AGE_3 +
  ...
  R[['bus']]  = asc_bus -
    ...
    log(1 + exp(b_co*(CO_CAR - FA_BUS)))*DRIV_LIC -
    log(1 + exp(b_co*(FA_HSR - FA_BUS)))*HSR_AV -
    log(1 + exp(b_co*(FA_AIR - FA_BUS)))*AIR_AV -
    log(1 + exp(b_fr*(FR_HSR - FR_BUS)))*HSR_AV -
    log(1 + exp(b_fr*(FR_AIR - FR_BUS)))*AIR_AV + b_age2*AGE_2 + b_age3_bus*AGE_3 +
  ...
  R[['hsr']] = asc_hsr - 
    ...
    log(1 + exp(b_co*(CO_CAR - FA_HSR)))*DRIV_LIC -
    log(1 + exp(b_co*(FA_BUS - FA_HSR)))*BUS_AV -
    log(1 + exp(b_co*(FA_AIR - FA_HSR)))*AIR_AV -
  ...
  R[['air']] = asc_air - 
    ...
    log(1 + exp(b_co*(CO_CAR - FA_AIR)))*DRIV_LIC -
    log(1 + exp(b_co*(FA_BUS - FA_AIR)))*BUS_AV -
    log(1 + exp(b_co*(FA_HSR - FA_AIR)))*HSR_AV -
    log(1 + exp(b_fr*(FR_BUS - FR_AIR)))*BUS_AV -
    log(1 + exp(b_fr*(FR_HSR - FR_AIR)))*HSR_AV + b_age2*AGE_2 + b_age3_air*AGE_3 +
...
# ----------------------------------------------------------------- #
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\Research note\\modelagem\\apollo_mc\\resultados")
