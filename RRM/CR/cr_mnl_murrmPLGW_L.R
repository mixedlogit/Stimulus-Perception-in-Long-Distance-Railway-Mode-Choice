...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  R[['car']]  =  asc_car + b_mu*( - 
                                    log(1 + exp(b_tt/b_mu*(TT_BUS - TT_CAR)/(TT_CAR**b_fi)))*BUS_AV -
                                    log(1 + exp(b_tt/b_mu*(TT_CR - TT_CAR)/(TT_CAR**b_fi)))*CR_AV -
                                    log(1 + exp(b_tt/b_mu*(TT_AIR - TT_CAR)/(TT_CAR**b_fi)))*AIR_AV) +
    b_mu*(-log(1 + exp((b_co*FA_BUS - b_cocar*CO_CAR)/(CO_CAR**b_fi)))*BUS_AV -
  ...
  R[['bus']]  = asc_bus + b_mu*(
    ...
    b_mu*(-log(1 + exp((b_cocar*CO_CAR - b_co*FA_BUS)/(FA_BUS**b_fi)))*DRIV_LIC -
            log(1 + exp(b_co*FA_CR - b_co*FA_BUS)/(FA_BUS**b_fi))*CR_AV -
            log(1 + exp(b_coair*FA_AIR - b_co*FA_BUS)/(FA_BUS**b_fi))*AIR_AV) +
    b_mu*(-log(1 + exp(b_fr*(FR_CR - FR_BUS)/(FR_BUS**b_fi)))*CR_AV -
  ...
  R[['cr']] = asc_cr - 
    ...
    log(1 + exp(b_co*FA_BUS - b_co*FA_CR)/(FA_CR**b_fi))*BUS_AV -
  ...
  R[['air']] = asc_air + b_mu*(- 
    ...
    b_mu*(-log(1 + exp(b_cocar*CO_CAR - b_coair*FA_AIR)/(FA_AIR**b_fi))*DRIV_LIC -
            log(1 + exp(b_co*FA_BUS - b_coair*FA_AIR)/(FA_AIR**b_fi))*BUS_AV -
            log(1 + exp(b_co*FA_CR - b_coair*FA_AIR)/(FA_AIR**b_fi))*HSR_AV) +
    b_mu*(-log(1 + exp(b_fr*(FR_BUS - FR_AIR)/(FR_AIR**b_fi)))*BUS_AV -
