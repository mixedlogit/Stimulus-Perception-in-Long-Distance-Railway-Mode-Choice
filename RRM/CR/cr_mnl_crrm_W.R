...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  R[['car']]  =  asc_car - 
            ...
            log(1 + exp(b_tt*(TT_CR - TT_CAR)))*CR_AV -
            log(1 + exp(b_tt*(TT_AIR - TT_CAR)))*AIR_AV -
            log(1 + exp(b_co*(FA_BUS - CO_CAR)))*BUS_AV -
            log(1 + exp(b_cocr*FA_CR - b_co*CO_CAR))*CR_AV -
            log(1 + exp(b_coair*FA_AIR - b_co*CO_CAR))*AIR_AV + b_age2_car*AGE_2 + b_age3*AGE_3 +
  ...
  R[['bus']]  = asc_bus -
    ...
    log(1 + exp(b_cocr*FA_CR - b_co*FA_BUS))*CR_AV -
    log(1 + exp(b_coair*FA_AIR - b_coair*FA_BUS))*AIR_AV -
    log(1 + exp(b_fr*(FR_CR - FR_BUS)))*CR_AV -
  ...
  R[['cr']] = asc_cr - 
    ...
    log(1 + exp(b_co*CO_CAR - b_cocr*FA_CR))*DRIV_LIC -
    log(1 + exp(b_co*FA_BUS - b_cocr*FA_CR))*BUS_AV -
    log(1 + exp(b_coair*FA_AIR - b_cocr*FA_CR))*AIR_AV -
  ...
  R[['air']] = asc_air - 
    ...
    log(1 + exp(b_co*CO_CAR - b_coair*FA_AIR))*DRIV_LIC -
    log(1 + exp(b_co*FA_BUS - b_coair*FA_AIR))*BUS_AV -
    log(1 + exp(b_cocr*FA_CR - b_coair*FA_AIR))*HSR_AV -
    log(1 + exp(b_fr*(FR_BUS - FR_AIR)))*BUS_AV -
    log(1 + exp(b_fr*(FR_CR - FR_AIR)))*HSR_AV + b_age2*AGE_2 + b_age3*AGE_3 +
    b_inc2*INC_2 + b_inc3*INC_3
