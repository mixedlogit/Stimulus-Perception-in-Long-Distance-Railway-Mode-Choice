...
### Set core controls
apollo_control = list(
  modelName    = 'mnl_rum 16',
  modelDescr   = "MNL RUM model for choice mode data",
  indivID      = "ID",
  outputDirectory = "C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rum\\CR\\L"
)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['cr']] = asc_cr + (b_tt*TT_CR + b_co*FA_CR + b_fr*FR_CR) 
  
  V[['air']] = asc_air +  (b_tt*TT_AIR + b_coair*FA_AIR + b_fr*FR_AIR) + b_age2_air*AGE_2 + b_age3_air*AGE_3  + 
...
apollo_lrTest('mnl_rum 16','mnl_rum 15')
