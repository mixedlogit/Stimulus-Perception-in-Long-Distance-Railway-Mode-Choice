...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['car']]  = asc_car + (b_tt*TT_CAR + b_co*CO_CAR) + b_age2_car*AGE_2 + b_age3_car*AGE_3 +
...
setwd("C:\\Users\\calde\\Google Drive\\Mestrado 2019_Gabriel Caldeira\\Artigos\\4_Mixed model - SP Rail\\Model\\First Paper\\mnl_rum\\HSR\\W")
...
apollo_lrTest('mnl_rum 15','mnl_rum 16')
